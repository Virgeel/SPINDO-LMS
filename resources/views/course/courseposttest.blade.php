    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <p class="card-title">Post-Test </p>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0">
        <h5 class="modal-title" id="scoreModalLabel">Hasil Post-Test</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body text-center">
        <h1 class="display-4 text-success mb-3 fw-bold">80 / 100</h1>
        <p class="lead">Selamat! Anda telah menyelesaikan Post-Test dengan baik.</p>
      </div>

      <div class="modal-footer border-0 justify-content-center">
        <a href="{{ route('coursefinish') }}" class="btn btn-primary">Selesai</a>
      </div>
    </div>
  </div>
</div>
