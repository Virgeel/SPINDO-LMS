...
Route::get('/course/home',[CourseController::class,'home'])->name('coursehome');
Route::get('/course/home/single',[CourseController::class,'single'])->name('coursesingle');
Route::get('/course/home/single/pretest',[CourseController::class,'coursepretest'])->name('coursepretest');
Route::get('/course/home/single/posttest',[CourseController::class,'courseposttest'])->name('courseposttest');
...
Route::get('/dahsboard/jobposition/create',[DashboardJobPositionController::class,'createjobposition'])->name('dashboard.createjobposition');
Route::get('/dashboard/jobposition/add',[DashboardJobPositionController::class,'addjobposition'])->name('dashboard.addjobposition');
